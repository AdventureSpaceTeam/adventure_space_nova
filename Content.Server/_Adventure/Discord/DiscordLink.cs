...
public sealed class DiscordLink : IPostInjectInit
{
    ...
    {
        _configuration.OnValueChanged(ACVars.DiscordGuildId, OnGuildIdChanged, true);
        _configuration.OnValueChanged(ACVars.DiscordPrefix, OnPrefixChanged, true);
        ...
        if (_configuration.GetCVar(ACVars.DiscordToken) is not { } token || token == string.Empty)
        {
        ...
        if (_configuration.GetCVar(ACVars.DiscordGuildId) == string.Empty || _configuration.GetCVar(ACVars.DiscordPrefix) == string.Empty)
        {
    ...
    public void Shutdown()
    {
        ...
        _configuration.UnsubValueChanged(ACVars.DiscordGuildId, OnGuildIdChanged);
        _configuration.UnsubValueChanged(ACVars.DiscordPrefix, OnPrefixChanged);
    }
