using Content.Server.AdventurePrivate._Alteros.DarkForces.Saint.Items.Events;
...
namespace Content.Server.AdventurePrivate._Alteros.DarkForces.Saint.Saintable;
...
public sealed class SaintedSystem : EntitySystem
{
    ...
    private void OnSaintSilverPickedUpAttemptEvent(EntityUid uid,
        SaintSilverComponent component,
    ...
    private void OnSaintPickedUpAttemptEvent(EntityUid uid,
        SaintedComponent component,
        GettingPickedUpAttemptEvent args)
    {
        if (args.Cancelled)
            return;
    ...
    {
        OnAfterInteractEvent(uid,
            args,
            () => new OnSilverEntityAfterInteract(component.DamageOnCollide, component.PushOnCollide));
    }
    ...
    private void OnAfterInteract(EntityUid uid, SaintedComponent component, AfterInteractEvent args)
    {
        OnAfterInteractEvent(uid,
            args,
            () => new OnSaintEntityAfterInteract(component.DamageOnCollide, component.PushOnCollide));
    }
    ...
    private void OnCollideSilver(EntityUid uid, SaintSilverComponent component, ref StartCollideEvent args)
    {
        OnCollideEvent(uid,
            ref args,
            () => new OnSilverEntityCollide(component.DamageOnCollide, component.PushOnCollide));
    }
    ...
    private void OnCollideStart(EntityUid uid, SaintedComponent component, ref StartCollideEvent args)
    {
        OnCollideEvent(uid,
            ref args,
            () => new OnSaintEntityCollide(component.DamageOnCollide, component.PushOnCollide));
    }
    ...
    private void CauseHolyDamage(EntityUid uid, EntityUid target, DamageSpecifier damageSpecifier, bool pushOnCollide)
    {
        ...
        _throwing.TryThrow(target, playerDir - fieldDir, 25);
    }
