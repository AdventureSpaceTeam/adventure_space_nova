using Content.Server.AdventurePrivate._Alteros.DarkForces.Narsi.Cultist.Abilities.Blindness;
...
public sealed partial class NarsiCultistAbilitiesSystem
{
    ...
    private void OnSaintWaterDrinkBlindness(EntityUid uid,
        NarsiBlindnessComponent component,
        OnSaintWaterDrinkEvent args)
    {
        ClearBlindness(uid);
    }

    private void OnSaintWaterFlammableBlindness(EntityUid uid,
        NarsiBlindnessComponent component,
    ...
    private void OnSaintAfterInteractBlindness(EntityUid uid,
        NarsiBlindnessComponent component,
        OnSaintEntityAfterInteract args)
    {
        ClearBlindness(uid);
    }
    ...
    private void OnBlindnessEvent(EntityUid uid, NarsiCultistComponent component, NarsiCultistBlindnessEvent args)
    {
        ...
        _statusEffectsSystem.TryAddStatusEffect(target,
            "TemporaryBlindness",
            TimeSpan.FromSeconds(blindnessTime),
            true,
            "TemporaryBlindness");
