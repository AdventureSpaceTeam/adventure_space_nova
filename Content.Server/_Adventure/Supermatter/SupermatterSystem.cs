...
using Content.Shared._Adventure.Supermatter;
using Content.Shared._Adventure.Supermatter.Components;
...
namespace Content.Server._Adventure.Supermatter;
...
public sealed class SupermatterSystem : SharedSupermatterSystem
{
    public override void Initialize()
    {
        ...
        _supermatterImmuneQuery = GetEntityQuery<SupermatterImmuneComponent>();
    ...
    public sealed class HandleOutputJob : Job<object>
    {
        ...
        private readonly Entity<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent> _ent;
        private readonly GasMixture _gasMixture;
        private readonly CancellationToken _cancellation;

        public HandleOutputJob(float frameTime, SupermatterSystem self, Entity<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent> ent, GasMixture gasMixture, double maxTime, CancellationToken cancellation = default) : base(maxTime, cancellation)
        {
        ...
        public HandleOutputJob(float frameTime, SupermatterSystem self, Entity<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent> ent, GasMixture gasMixture, double maxTime, IStopwatch stopwatch, CancellationToken cancellation = default) : base(maxTime, stopwatch, cancellation)
        {
            _frameTime = frameTime;
            _self = self;
            _ent = ent;
    ...
    public sealed class HandleDamageJob : Job<object>
    {
        ...
        public HandleDamageJob(float frameTime, SupermatterSystem self, Entity<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent> ent, GasMixture? gasMixture, double maxTime, CancellationToken cancellation = default) : base(maxTime, cancellation)
        {
            _frameTime = frameTime;
            _self = self;
            _ent = ent;
        ...
        public HandleDamageJob(float frameTime, SupermatterSystem self, Entity<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent> ent, GasMixture? gasMixture, double maxTime, IStopwatch stopwatch, CancellationToken cancellation = default) : base(maxTime, stopwatch, cancellation)
        {
            _frameTime = frameTime;
            _self = self;
            _ent = ent;
    ...
    public override void Update(float frameTime)
    {
        ...
        var q = EntityQueryEnumerator<SupermatterComponent, ExplosiveComponent, RadiationSourceComponent, MetaDataComponent>();
    ...
    private EntityQuery<SupermatterImmuneComponent> _supermatterImmuneQuery;
