...
using Content.Server.AdventurePrivate._Alteros.Medical.Disease.Diagnosis.Swab;
...
namespace Content.Server.AdventurePrivate._Alteros.Medical.Disease.Diagnosis.Diagnoser;
