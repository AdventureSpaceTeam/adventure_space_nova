...
namespace Content.Server.AdventurePrivate._Alteros.DarkForces.Desecrated.Pontific.DarkAltar;
...
public sealed class PontificDarkAltarSystem : EntitySystem
{
    ...
    {
        _radio.SendRadioMessage(altarUid,
            message,
            _prototype.Index<RadioChannelPrototype>(RadioChannelPrototype),
            altarUid);
    }
