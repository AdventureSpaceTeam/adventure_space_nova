...
public sealed class NarsiRitualDaggerSystem : EntitySystem
{
    ...
    private void OnCreateRuneEvent(EntityUid uid,
        NarsiRitualDaggerComponent component,
    ...
    private void OnClearRuneEvent(EntityUid uid,
        NarsiRitualDaggerComponent component,
    ...
    {
        if (!HasComp<NarsiCultistComponent>(uid))
            return;
    ...
    private void AddVerbToRitualDagger(EntityUid uid, NarsiRitualDaggerComponent component, GetVerbsEvent<Verb> args)
    {
        ...
        Verb runes = new()
        {
            ...
            Icon = new SpriteSpecifier.Rsi(
                new ResPath("/Textures/DarkStation/MainGame/DarkForces/Cult/Entities/Runes/rune.rsi"),
                "offering"),
        };
    ...
    private void SendCreateNarsiRuneEvent(EntityUid dagger, EntityUid user, string prototype)
    {
        ...
        _doAfterSystem.TryStartDoAfter(doAfterEventArgs);
        _audioSystem.PlayEntity(BloodSound,
