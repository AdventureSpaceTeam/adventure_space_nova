...
public sealed partial class NarsiCultProgressSystem
{
    ...
    private void CreateSomeObjectives(Entity<NarsiCultProgressComponent> objectiveProgress,
        string objectiveId,
        int min,
        int max)
    {
    ...
    private void OnObjectiveCompleted(NarsiCultObjectiveCompleted args)
    {
        ...
        SendMessageFromNarsi(progress,
            $"Вы выполнили задание. За это вы получили {bloodPoints} очков Крови. Используйте их для изучения новых способностей или улучшения текущих!");
