...
using Content.Shared._Adventure.DarkForces.Narsi.Buildings.CreatureEgg;
...
namespace Content.Server._Adventure.DarkForces.Narsi.Buildings.CreatureEgg;
...
public sealed class NarsiCreatureEggSystem : EntitySystem
{
    ...
    private void OnGetVerb(EntityUid uid, NarsiCreatureEggComponent component, GetVerbsEvent<Verb> args)
    {
        ...
        var verb = new Verb
        {
            ...
            Icon = new SpriteSpecifier.Rsi(
                new ResPath("/Textures/DarkStation/MainGame/DarkForces/Cult/Structures/creature_egg.rsi"),
                "stage-1"),
    ...
    private void OnInsertedToContainer(EntityUid uid,
        NarsiCreatureEggComponent component,
