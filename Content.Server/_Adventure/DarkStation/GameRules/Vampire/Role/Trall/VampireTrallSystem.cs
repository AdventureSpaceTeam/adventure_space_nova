...
namespace Content.Server._Adventure.GameRules.Vampire.Role.Trall;

public sealed class VampireTrallSystem : EntitySystem
{
    private static readonly TimeSpan ParalyzeOnDeTrall = TimeSpan.FromSeconds(5);
    ...
    private void OnVampireTrallDrinkSaintWater(EntityUid uid,
        VampireTrallComponent component,
    ...
    private void OnVampireTrallFlammableSaintWater(EntityUid uid,
        VampireTrallComponent component,
    ...
    private void SetupAntagonistRole(EntityUid uid, EntityUid mindId, VampireTrallComponent component)
    {
        ...
        _roleSystem.MindAddRole(mindId,
            new VampireTrallRoleComponent
            {
                PrototypeId = antagPrototype.ID,
            });
        _roleSystem.MindTryRemoveRole<RoleBriefingComponent>(mindId);
