...
namespace Content.Server.Entry
{
    public sealed class EntryPoint : GameServer
    {
        ...
        [Dependency] private readonly TTSManager _ttsManager = default!; // c4llv07e tts
        [Dependency] private readonly SponsorsManager _sponsorsManager = default!; // c4llv07e sponsors
        [Dependency] private readonly AdventureConfigManager _advCfgManager = default!; // AdvSpace Config
        ...
        public override void Init()
        {
            ...
            _ttsManager.Initialize(); // c4llv07e tts
            _sponsorsManager.Initialize(); // c4llv07e sponsors
            _advCfgManager.Initialize(); // AdvSpace Config
            _advPresetManager.Initialize(); // AdvSpace Preset
            _dsAuthManager.Initialize(); // adventure discord auth
