...
public abstract partial class SharedAtmosphereSystem
{
    ...
    public virtual bool IsMixtureFuel(GasMixture mixture, float epsilon = Atmospherics.GasMinMoles)
        => throw new NotImplementedException();

    public virtual bool IsMixtureOxidizer(GasMixture mixture, float epsilon = Atmospherics.GasMinMoles)
        => throw new NotImplementedException();
