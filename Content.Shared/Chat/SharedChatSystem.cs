...
public abstract partial class SharedChatSystem : EntitySystem
{
    ...
    public static readonly SoundSpecifier DefaultAnnouncementSound
        = new SoundPathSpecifier("/Audio/_Corvax/Announcements/announce.ogg"); // Corvax-Announcements
    public static readonly SoundSpecifier CentComAnnouncementSound
        = new SoundPathSpecifier("/Audio/_Corvax/Announcements/centcomm.ogg"); // Corvax-Announcements
