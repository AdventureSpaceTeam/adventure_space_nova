...
bounty-item-remains = Сердце легиона
...
#ADV BOUNTIES
bounty-item-cupcakes = Кекс
bounty-item-medibot = Медибот
bounty-item-bouquet = Букет
bounty-item-cleanbot = Чистобот
bounty-item-control-modsuit = Р.И.Г.
bounty-description-cupcakes = Капитан одного из объектов содружественной корпорации Qillu объявила по каналу экстренной помощи что её срочно нужен "кекс?". Испеките и пришлите несколько.
bounty-description-medibot = Оптимизации в отделе кадров, прошла успешно! Теперь станции в секторе испытывают нехватку квалифицированных врачей. Потребуется время на поиск и найм новых сотрудников, а пока станции запрашивают медиботов для временного замещения и разгрузки работающего персонала.
bounty-description-bouquet = Похоронный отдел корпорации запрашивает пополнение букетов по причине высокого спроса услуг.
bounty-description-cleanbot = Посол Nanotrasen в секторе Фронтира внезапно установил контакт с представителем ксеноморфов, сидя прям в своём кресле своего кабинета. Мы займемся новыми чистыми штанами для посла, а уборка лужи ложится на вас.
bounty-description-control-modsuit = Внимание, в соседний сектор прибывает адмирал НТ на проверку цели. И, скорее всего, после бани, он пойдет париться на Лаваленд. Он слишком занятой, чтобы надевать скафандр. Отправьте ему Р.И.Г.
