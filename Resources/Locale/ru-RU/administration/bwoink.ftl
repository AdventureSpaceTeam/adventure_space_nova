...
admin-ahelp-admin-only-tooltip = Если включено, сообщение не будет отображено у игрока,
    однако всё ещё будет видно другим администраторам и также будет передано в Discord.
