nano-chat-program-name = НТ-грам
nano-chat-title = НТ-грам
...
log-probe-scan-nanochat = Отсканированы НТ-грам логи {$card}
log-probe-header-access = Сканер логов доступов
log-probe-header-nanochat = Сканер логов НТ-грам
