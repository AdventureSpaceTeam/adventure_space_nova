...
ent-ClothingOuterHardsuitEVAPrisoner = тюремный скафандр EVA
    .desc = Аварийный скафандр EVA, предназначенный для заключённых. Он ужасно медленный и не имеет температурной защиты, но его достаточно, чтобы спастись от сурового вакуума космоса.
