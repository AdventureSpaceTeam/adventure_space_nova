...
ent-BrutepackAdvanced1 = { ent-MedicatedSuture }
    ...
    .suffix = Один
ent-Bloodpack = пакет физраствора
    .desc = Содержит универсальный кровезаменитель, подстраивается под любую кровь гуманоида, разработан и проверен временем передовыми химиками компании Nanotrasen.
    .suffix = Полный
