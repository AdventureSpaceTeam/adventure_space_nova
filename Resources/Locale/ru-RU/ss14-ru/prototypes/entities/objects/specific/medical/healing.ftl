...
ent-BrutepackAdvanced1 = { ent-MedicatedSuture }
    ...
    .suffix = Один
ent-Bloodpack = пакет с физраствором
    .desc = Содержит физраствор, что является универсальной подбавкой для крови каждой расы, работающей на территории Nanotrasen.
    .suffix = Полный
