...
ent-MaterialSiloMachineCircuitboard = силосное хранилище (машинная плата)
    .desc = Печатная плата для силосного хранилища.
...
ent-CutterMachineCircuitboard = резательный станок (машинная плата)
    .desc = Печатная плата для резательного станка.
