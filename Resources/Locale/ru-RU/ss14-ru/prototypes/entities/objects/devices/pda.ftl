...
ent-BotanistPDA = КПК ботаника
    .desc = Пахнет землёй.
ent-SeniorBotanistPDA = КПК мастера-ботаника
    .desc = Похоже, за свою службу он повидал много грязи.
...
ent-LawyerPDA = КПК юриста
    .desc = Для юристов, переманивающих сомнительных клиентов.
...
ent-ScurretPDA = { ent-ClearPDA }
    .desc = Временный КПК для скурретов-стажёров. Не делает ничего особенного. Вава!
