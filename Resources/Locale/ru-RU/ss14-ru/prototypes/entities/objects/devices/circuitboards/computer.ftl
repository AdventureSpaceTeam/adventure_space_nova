...
ent-CargoRequestComputerCircuitboard = грузовая консоль заказа грузов (консольная плата)
    .desc = Консольная плата для грузовой консоли заказа грузов.
...
ent-FundingAllocationComputerCircuitboard = консоль распределения финансирования (консольная плата)
    .desc = Консольная плата для консоли распределения финансирования.
ent-CentcommCommsComputerCircuitboard = консоль связи ЦентКом (консольная плата)
    .desc = Консольная плата для консоли связи ЦентКом.
