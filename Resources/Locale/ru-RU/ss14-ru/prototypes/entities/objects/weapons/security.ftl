...
ent-Sunbaton = дубинка-солнце
    .desc = Электросолнечная дубинка для обездвиживания людей. Слишком усердное причинение вреда с помощью этого предмета считается дурным тоном. Она слишком яркая.
