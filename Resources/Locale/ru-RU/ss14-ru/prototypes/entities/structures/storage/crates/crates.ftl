...
ent-CrateLivestock = ящик для скота
    .desc = { ent-CrateGeneric.desc }
ent-CrateNPCGoliath = ящик для скота
    .desc = { ent-CrateGeneric.desc }
...
ent-InvisibleCrate = { ent-CrateBaseWeldable }
    .suffix = Стелс
    .desc = { ent-CrateBaseWeldable.desc }
ent-CrateBaseLockBox = ящик-сейф
    .desc = Надёжный ящик-сейф. Выручка от его продажи будет перечисленна в назначенный отдел. Но помните: Снабжение всегда берёт свою долю.
ent-CrateLockBoxEngineering = инженерный ящик-сейф
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxMedical = медицинский ящик-сейф
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxScience = научный ящик-сейф
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxSecurity = ящик-сейф службы безопасности
    .desc = { ent-CrateBaseLockBox.desc }
ent-CrateLockBoxService = сервисный ящик-сейф
    .desc = { ent-CrateBaseLockBox.desc }
