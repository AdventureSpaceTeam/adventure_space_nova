...
ent-CrateFunFoamGuns = набор пенопластового оружия
    .desc = Четыре ствола Сила Пенопласта, гранаты и патроны про запас. Только [ДАННЫЕ УДАЛЕНЫ] и точка!
ent-CrateFunScurret = увлажнённый скуррет
    .desc = Погоди, чего?
