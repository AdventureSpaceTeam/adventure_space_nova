...
ent-CrateSecurityRiot = ящик нелетального метательного снаряжения
    .desc = Содержит по коробке светошумовых, травматических и слезоточивых гранат. Также содержит 4 болы. Чтобы открыть, необходим уровень доступа Служба безопасности.
